  ...
  <svg :class="['stars']" viewBox="-20 -10 600 389.77">
    <defs>
      <pattern id="image-1" width="1" height="1">
        <image v-bind="{'href':imageBaseUrl + items[0].imagePath}" height="220" width="220" />
      </pattern>
      <pattern id="image-2" width="1" height="1">
        <image v-bind="{'href':imageBaseUrl + items[1].imagePath}" height="200" width="200" />
      </pattern>
      <pattern id="image-3" width="1" height="1">
        <image v-bind="{'href':imageBaseUrl + items[2].imagePath}" height="220" width="220" />
      </pattern>
    </defs>
